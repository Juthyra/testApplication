...
import testapp.repository.CustomerRepository;

/**
 * Service Implementation for managing {@link testapp.domain.Customer}.
 */
@Service
@Transactional
    ...
    public Mono<Customer> partialUpdate(Customer customer) {
        ...
        return customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getFamilyMember() != null) {
                    existingCustomer.setFamilyMember(customer.getFamilyMember());
                }
