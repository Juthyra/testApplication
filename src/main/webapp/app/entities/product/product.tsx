            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('bookTitle')}>
                  Book Title <FontAwesomeIcon icon={getSortIconByFieldName('bookTitle')} />
                </th>
                <th className="hand" onClick={sort('bookPrice')}>
                  Book Price <FontAwesomeIcon icon={getSortIconByFieldName('bookPrice')} />
                </th>
                <th className="hand" onClick={sort('bookQuantity')}>
                  Book Quantity <FontAwesomeIcon icon={getSortIconByFieldName('bookQuantity')} />
                </th>
                <th />
              </tr>
            </thead>
