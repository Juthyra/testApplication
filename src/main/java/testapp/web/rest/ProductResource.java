...
import testapp.service.ProductService;
import testapp.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link testapp.domain.Product}.
 */
@RestController
...
public class ProductResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<Product>> createProduct(@RequestBody Product product) throws URISyntaxException {
